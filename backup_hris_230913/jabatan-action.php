...
if( isset($_SERVER['REQUEST_METHOD']) AND strtoupper($_SERVER['REQUEST_METHOD'])=='POST' )
{
	...
	if( $ERROR_REQUIRE ){
		...
		$FIELDS = array(
			...
			'R_POT_LATE_TUNJ_MAKAN','R_POT_LATE_TUNJ_KEHADIRAN',
			'R_POT_EARLY_TUNJ_KEHADIRAN',
...
<section class="container-fluid" style="margin-top:70px;">
	<h1 class="border-title">
		...
		<?php if($OP=='edit'){ echo '<a href="jabatan-action.php?op=add" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Add New</a>'; } ?>
	</h1>
	<?php include 'msg.php' ?>

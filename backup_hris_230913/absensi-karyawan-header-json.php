...
rownumbers:true,
frozenColumns:[[
{field:'KARYAWAN_ID',title:'ID',width:40,sortable:true,align:'center'},
...
$AR = array(
	'DAY', 'ATT', 'ABS', 'LATE', 'EARLY', 'SAKIT', 'IJIN', 'SKD', 'LEMBUR', 'CT', 'CI', 'OFF', 'R', 'BM', 'CM', 'DINAS', 'SM', 'UL', 'OL'
);
foreach ($AR as $val) {
?>

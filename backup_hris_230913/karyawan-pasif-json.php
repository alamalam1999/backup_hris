...
set_search('KARYAWAN_PASIF', array('sort','order','JABATAN_ID','PROJECT_ID','COMPANY_ID','NAMA','ST_KERJA'));
if( get_input('clear') ) clear_search('KARYAWAN_PASIF', array('JABATAN_ID','PROJECT_ID','COMPANY_ID','NAMA','ST_KERJA'));
...
$where = '';
$wh = array();
$wh[] = " (A.ST_KERJA != 'AKTIF' AND A.ST_KERJA != '') ";
...
if($ST_KERJA = get_input('ST_KERJA') AND !empty($ST_KERJA)) $wh[] = " A.ST_KERJA = '$ST_KERJA' ";

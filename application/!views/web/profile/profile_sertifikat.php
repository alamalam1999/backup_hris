          ...
          <?php
            ...
            ?>
                    <tr class="bg-secondary ">
                        ...
                        <td>
                          <a onclick="notifikasi('Yakin ingin hapus ?','<?=base_url("profile_sertifikat/delete/$row->DOK_KARYAWAN_ID") ?>')" class="btn btn-danger text-white"> <span class="fa fa-trash" ></span> Hapus</a>
                        </td>
                    </tr>
          ...
          <div class="row">
                  ...
                  //if ($data_sertifikat->num_rows() > 0) {
                      ...
                      <tbody style="border-top: 0;">
  										...
  										<tr>
  											<td>
  												<input type="checkbox" name="SIO[]" value="ADA" <?php if ($row->SIO == 'ADA') echo 'checked'; ?> disabled> SIO
  											</td>
  											<td>
  										...
  										<tr>
  											<td>
  												<input type="checkbox" name="KTA[]" value="ADA" <?php if ($row->KTA == 'ADA') echo 'checked'; ?> disabled> KTA
  											</td>
  											<td>

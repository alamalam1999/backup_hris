    ...
    <ul class="sidebar-menu mt-2">
      ...
      <li class="dropdown <?php echo in_array($url1, array('profile', 'profile_sertifikat', 'profile_pendidikan')) ? 'active' : ''; ?>">
        ...
        <ul class="dropdown-menu">
          ...
          <li <?php if ($url1 == 'profile_sertifikat') echo ' class="active"'; ?>><a class="nav-link" href="<?php echo site_url('profile_sertifikat'); ?>">Sertifikat</a></li>
          <li <?php if ($url1 == 'profile_pendidikan') echo ' class="active"'; ?>><a class="nav-link" href="<?php echo site_url('profile_pendidikan'); ?>">Pendidikan</a></li>
          ...
          <li <?php if ($url1 == 'profile_keluarga') echo ' class="active"'; ?>><a class="nav-link" href="<?php echo site_url('profile_keluarga'); ?>">Keluarga</a></li>

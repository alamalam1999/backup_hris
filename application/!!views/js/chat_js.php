<script type="text/javascript">
  $(document).ready(function() {
    ...
    function getUserList() {
      return new Promise(function(resolve, reject) { //Creating new Promise Chain
        ...
        $('.innerBox').click(function() {
          ...
          // getBlockUserData();
          // setInterval(getBlockUserData, 10000);

          getUserDetails(unique_id);
          //inter2 = setInterval(getUserList, 10000);
    ...
    //set pertama get all user

    getUserList(); //Calling the root function without interval
    //inter2 = setInterval(getUserList, 10000); //Calling the root function with interval
  })
</script>
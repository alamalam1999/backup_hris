  ...
  <div class="col-md-12">
    <div class="table-responsive">
      ...
      <table class="table table-bordered">
        <tr style="background-color: #E9ECEF; color: #495057;">
          ...
          <th colspan="2" class="text-right">
            <span class="input-group-btn" style="display: inline;">
              <button type="button" class="btn btn-primary btn-flat" title="Tambah Data Keluarga"   data-toggle="modal" data-target="#modal_2">
        ...
        <?php
          foreach ($KEL_BESAR->result() as $key => $row) { ?>
            <tr>
              <td><?php echo $key + 1 ?></td>
              <td>
                <select class="form-control" name="ANGGOTA_KELUARGA" disabled>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="" action="<?= base_url('profile_keluarga/proses_add') ?>" method="post">
            <input type="hidden" name="JENIS" value="BESAR">

            <div class="modal-header">
              <h5 class="modal-title" >Keluarga Besar</h5>

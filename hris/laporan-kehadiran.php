...
is_login('laporan-kehadiran.view');
...
//$laporan_name = 'Laporan_Kehadiran-'..'.xls';
?>
	...
	<div class="row" style="margin:10px 0;">
		<div class="col-sm-2">
			<div class="dropdown">
				...
				<li><a href="javascript:;" onclick="$('#t').datagrid('toExcel','LAPORAN KEHADIRAN - '+$('#PERIODE_ID option:selected').html()+' - '+$('#PROJECT_ID option:selected').html()+' ('+$('#VIEW_MODE option:selected').html()+' ).xls')"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;Export</a></li>
				</ul>
			</div>
		</div>
		<div class="col-sm-2">
		...
		<div class="col-sm-2">
			<h1 style="margin:0;text-align:right;">Lap. Kehadiran</h1>
		</div>
	</div>
	</form>
...
{
	$.ajax({
		url : 'laporan-kehadiran-header-json.php',
		data : {

...
if (isset($_SERVER['REQUEST_METHOD']) and strtoupper($_SERVER['REQUEST_METHOD']) == 'POST') {
	...
	if ($ERROR_REQUIRE) {
		...
		$FIELDS = array(
			'PERIODE_ID', 'KARYAWAN_ID', 'KETERANGAN', 'TANGGAL', 'JAM_MULAI', 'JAM_SELESAI', 'JENIS', 'STAFF'
		);
		...
		<div class="row">
			...
			");
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<?php echo dropdown('STAFF', array('1' => 'STAFF', '0' => 'NON STAFF'), set_value('STAFF', $EDIT->STAFF), ' class="form-control" ') ?>
					</div>
				</div>

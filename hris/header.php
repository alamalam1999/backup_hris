				...
				<div class="collapse navbar-collapse" id="navbar-collapse-1">
					<ul class="nav navbar-nav" >
						...
						*/
						...
						$sub_transaksi .= access_button('transaksi', 'tmp.view', '<li><a href="tmp.php">TMP</a></li>');
						...
						*/
						...
						$sub_laporan .= access_button('laporan', 'laporan-tmp.view', '<li><a href="laporan-tmp.php">Laporan TMP</a></li>');
						...
						*/
						...
						<?php if ($sub_rekrutmen) { ?>
							<li class="dropdown <?php echo isset($M['rekrutmen']) ? 'active' : '' ?>">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Rekrutmen<?php echo $_NOTIF_REKRUTMEN ?> <span class="caret"></span></a>
								<ul class="dropdown-menu">
						...
						<?php if ($sub_absensi) { ?>
							<li class="dropdown <?php echo isset($M['absensi']) ? 'active' : '' ?>">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Kehadiran<?php echo $_NOTIF_ABSENSI ?> <span class="caret"></span></a>
								<ul class="dropdown-menu">

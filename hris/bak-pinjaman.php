...
<section class="container-fluid">
	<div class="row" style="margin:10px 0;">
		...
		<div class="col-sm-2">
			<?php echo dropdown('PERIODE_ID',dropdown_option('periode','PERIODE_ID','PERIODE','ORDER BY PERIODE_ID DESC'),get_search('PINJAMAN','PERIODE_ID'),' id="PERIODE_ID" class="form-control input-sm" ') ?>
		</div>
		<div class="col-sm-2">
...
$(document).ready(function(){
	...
	$('#btn-edit').click(function(){
		...
		else window.location = 'pinjaman-action.php?op=edit&id='+sel.PINJAMAN_ID;
		return false;
	});
	$('#btn-delete').click(function(){
		...
		else if(confirm('Are you sure?'))
		{
			...
			if (REASON != null) {
				window.location = 'pinjaman-action.php?op=delete&id='+sel.PINJAMAN_ID+'&reason='+REASON;
			}
		}
		return false;
	});

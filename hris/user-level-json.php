...
set_search('USER-LEVEL', array('sort','order','NAMA'));
if( get_input('clear') ) clear_search('USER-LEVEL', array('NAMA'));
...
$where = '';
$wh = array();
if($NAMA = get_input('NAMA') AND !empty($NAMA)) $wh[] = " UPPER(LEVEL) LIKE UPPER('%$NAMA%') ";
